...
import './App.css'
import CreateArrayWithInitialValues from './components/CreateArrayWithInitialValues'
import RemoveFirstLetterOfArray from './components/RemoveFirstLetterOfArray'
...
// You can do this with either class components or function components (I recommend function components), but there is no need to do both 
...
function App() {
  ...
  function storeArrayOfLetters(storeArrayOfLetters){
    console.log("loaded array")
    setArrayCreated(storeArrayOfLetters)
    console.log(arrayCreated)
  }

  return (
    <>
     <CreateArrayWithInitialValues storeArrayOfLetters={storeArrayOfLetters} ></CreateArrayWithInitialValues>
     <RemoveFirstLetterOfArray array={arrayCreated}></RemoveFirstLetterOfArray>
    </>
  )
}
